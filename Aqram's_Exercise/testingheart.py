...
def index():
    ...
    return render_template('HeartDisease_copy.html', form=form) 
...
def return_prediction(model, scaler, sample_json):
    ...
    if prediction == 0:
        return 'You are at risk of heart attack'
    else:
        return 'You are not at risk of heart attack'
...
def prediction():
    ...
    return render_template('prediction.html',results=(results),gender=(gen),ccp=(c),fblood=(blood),ec=(ecg),ex=(exercise),slo=(sl),tha=(th))
